...
# test_file=a.txt # the text file for training
output_path=../PTEforHNE/workspace/
...
# ./concatenate -input1 vec_1st.txt -input2 vec_2nd.txt -output vec_all.txt -binary 0

# ./rank -input vec_all.txt -pair cl.test.40000.net
